...
const body = {
  ...
  maxItems: 5,
  description:
    "내용. 문장체 문단 3~5개, 각 2~5문장. 신문 스트레이트 기사처럼 사실을 서술한다. 제공된 본문·리드의 구체 정보(숫자·기관·일정·인물·발언·배경·경과)를 빠뜨리지 말고 담아, 이것만 읽어도 사건이 이해되게 쓴다. **분량을 아끼지 않는다. 재료에 있는 사실은 전부 쓴다.** 단문, 온점 사용, 경어체 금지. 첫 문단이 핵심 사건, 이어서 경위·수치·발언·반응·전망 순이다.",
  items: { type: "string" },
};
