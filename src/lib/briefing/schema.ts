...
const points = {
  ...
  maxItems: 6,
  description:
    "본문. 개조식 불렛 4~6개. 각 40자 이내. **온점을 찍지 않는다.** 숫자를 앞에 쓰고 명사구나 '~함'으로 끝낸다. 리드문에 있는 구체 정보(숫자·기관·일정·인물)를 빠뜨리지 말고 담는다. 좋은 예: '코스피 3.1% 하락, 2696선'. 나쁜 예: '코스피가 3.1% 떨어져 2696선까지 밀렸다.'",
  items: { type: "string" },
};
